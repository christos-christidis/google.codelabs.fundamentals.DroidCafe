...
// SOS: the implementation is different from the tutorial, because the template 'Settings Activity'
// outputs different code now. But the principles are the same.
